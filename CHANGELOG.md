...
- **Docs**: sync all READMEs and docs/ with current codebase state (Expo 57, RN 0.86, Loop Templates, LLM client, Schedule Assistant, deploy/ configs, MIT license)
- **Docs**: replace app/README.md Expo boilerplate with Solo-specific content
- **Docs**: fix broken link in analysis/README.md, correct deployment.md contradiction about tracked deploy/ files
