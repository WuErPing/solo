...
OUT_DIR="/tmp/solo-workspace-create-android-focus-$(date +%s)"
VIDEO_DIR="/tmp/solo-maestro-videos"
DEVICE_VIDEO="/sdcard/solo-maestro-workspace-create-focused.mp4"
LOCAL_VIDEO="$VIDEO_DIR/solo-maestro-workspace-create-focused.mp4"
