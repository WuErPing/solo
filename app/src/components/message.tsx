...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_ID = "solo-toolcall-shimmer-keyframes";
const WEB_TOOLCALL_SHIMMER_ANIMATION_NAME = "solo-toolcall-shimmer";
...
const WEB_TOOLCALL_SHIMMER_KEYFRAME_CSS = `
  @keyframes ${WEB_TOOLCALL_SHIMMER_ANIMATION_NAME} {
    0% {
      background-position: var(--solo-shimmer-start, -200px) 0;
    }
    100% {
      background-position: var(--solo-shimmer-end, 200px) 0;
    }
  }
`;
...
function buildShimmerTextStyle(input: {
  ...
  return {
    ...
    "--solo-shimmer-start": `${input.webShimmerTrackStart - input.offsetX}px`,
    "--solo-shimmer-end": `${input.webShimmerTrackEnd - input.offsetX}px`,
  };
}
