...
export function WelcomeScreen({ onHostAdded }: WelcomeScreenProps) {
  ...
  const handleOpenSoloSite = useCallback(() => {
    void openExternalUrl("https://solo.sh");
  }, []);
          ...
          <View style={styles.copyBlock}>
            {isConnectingToSavedHosts ? (
              ...
              <>
                ...
                {isNative ? (
                  <Pressable style={styles.setupLink} onPress={handleOpenSoloSite}>
                    <Text style={styles.setupLinkText}>solo.sh</Text>
