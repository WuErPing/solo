    ...
    <View style={settingsStyles.card}>
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>Let Solo start and stop the built-in daemon</Text>
        </View>
        <Switch
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>Daemon keeps running when you quit Solo</Text>
        </View>
        <Switch
      ...
      <View style={ROW_WITH_BORDER_STYLE}>
        <View style={settingsStyles.rowContent}>
          ...
          <Text style={settingsStyles.rowHint}>
            Runs `solo daemon status` and shows the output
          </Text>
        </View>
        <Button
          variant="outline"
...
const ADVANCED_DAEMON_SETTINGS_URL = "https://solo.sh/docs/configuration";
