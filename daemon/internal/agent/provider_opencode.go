...
func NewOpenCodeAgentClient(binaryPath string, logger *slog.Logger) *OpenCodeAgentClient {
	return NewOpenCodeAgentClientWithSettings(binaryPath, logger, nil)
}

func NewOpenCodeAgentClientWithSettings(binaryPath string, logger *slog.Logger, settings *OpenCodeRuntimeSettings) *OpenCodeAgentClient {
...
func (c *OpenCodeAgentClient) Provider() string { return opencodeProviderName }

func (c *OpenCodeAgentClient) EnsureRunning(ctx context.Context) (string, error) {
...
func (c *OpenCodeAgentClient) CreateSession(ctx context.Context, config *protocol.AgentSessionConfig) (AgentSession, error) {
	if err := c.IsAvailable(ctx); err != nil {
		return nil, err
	}
...
func (c *OpenCodeAgentClient) ResumeSession(ctx context.Context, handle *protocol.AgentPersistenceHandle) (AgentSession, error) {
	if err := c.IsAvailable(ctx); err != nil {
		return nil, err
	}
...
func (c *OpenCodeAgentClient) ListClientCommands(ctx context.Context, cwd string) ([]protocol.AgentSlashCommand, error) {
	if err := c.IsAvailable(ctx); err != nil {
		return nil, err
	}
...
func (c *OpenCodeAgentClient) ListModels(ctx context.Context, cwd string) ([]protocol.AgentModelDefinition, error) {
	if err := c.IsAvailable(ctx); err != nil {
		return nil, err
	}
...
func (c *OpenCodeAgentClient) ListModes(ctx context.Context, cwd string) ([]protocol.AgentMode, error) {
	if err := c.IsAvailable(ctx); err != nil {
...
func (c *OpenCodeAgentClient) GetDiagnostic() string {
	var parts []string
