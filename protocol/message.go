...
func init() {
	...
	RegisterInbound("solo_worktree_archive_request", func() SessionInboundMessage { return &SoloWorktreeArchiveRequest{} })
	RegisterInbound("remove_project_request", func() SessionInboundMessage { return &RemoveProjectRequest{} })
